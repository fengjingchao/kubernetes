...
// Pod events are sent via network.
// We don't have guaranteed delivery of all events. The current informer uses DeltaQueue and Reflector.
// They might be slow and do a relist, which would lead to missing events.
//
